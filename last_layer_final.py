...
def train_last_layer(img_width, img_height,
    ...
    my_model.save('./inV3_last_layer_final_ver_2.h5')
    return history
...
if __name__=="__main__":
    ...
    test_data_dir = "./test"
    # num_image=13573
    num_image=10873 #Train的圖片總數
    num_test_image = 2700 #Test的圖片總數
    epochs = 10
